...
<div id="wrapper">
	...
	<div id="main">
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					<!-- 这里需要注意Action指定了namespace为/users，因此需要机上/users
					   这要调用的是UsersAction类的login方法
					 -->
	...
	<div id="footer">
		<div id="text">Copyright © 2009-2017 All Rights Reserved Powered By fy</div>
	</div>
</div>
</body>
</html>